...
Code requirements:
- **4+ scenes based on `AdventureScene`**: Hub, Planet1, Planet2, Planet3, Planet3-Moon.
- **2+ scenes *not* based on `AdventureScene`**: Intro, Peace Ending, War Ending (name the classes).
